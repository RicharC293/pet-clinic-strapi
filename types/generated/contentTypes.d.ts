...
export interface ApiOwnerOwner extends Schema.CollectionType {
  ...
  attributes: {
    ...
    pets: Attribute.Relation<'api::owner.owner', 'oneToMany', 'api::pet.pet'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiPetPet extends Schema.CollectionType {
  ...
  attributes: {
    ...
    owner: Attribute.Relation<'api::pet.pet', 'manyToOne', 'api::owner.owner'>;
    type: Attribute.Relation<'api::pet.pet', 'manyToOne', 'api::type.type'>;
    visits: Attribute.Relation<'api::pet.pet', 'oneToMany', 'api::visit.visit'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiSpecialitieSpecialitie extends Schema.CollectionType {
  ...
  attributes: {
    ...
    vets: Attribute.Relation<
      'api::specialitie.specialitie',
      'manyToMany',
      'api::vet.vet'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiTypeType extends Schema.CollectionType {
  ...
  attributes: {
    ...
    pets: Attribute.Relation<'api::type.type', 'oneToMany', 'api::pet.pet'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiVetVet extends Schema.CollectionType {
  collectionName: 'vets';
  info: {
    singularName: 'vet';
    pluralName: 'vets';
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::vet.vet', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::vet.vet', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiVisitVisit extends Schema.CollectionType {
  ...
  attributes: {
    pet: Attribute.Relation<'api::visit.visit', 'manyToOne', 'api::pet.pet'>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::specialitie.specialitie': ApiSpecialitieSpecialitie;
      'api::type.type': ApiTypeType;
      'api::vet.vet': ApiVetVet;
